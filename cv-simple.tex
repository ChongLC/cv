...
% Insert custom header right below the name
\vspace{0.1em}
\begin{center}
    \textbf{Computational Virologist | Life Science Researcher | Bioinformatician}
\end{center}
...
\raggedleft
$if(photo)$
\includegraphics[width=3.9cm,height=4.5cm,keepaspectratio]{$photo$}
$endif$
\end{minipage}
